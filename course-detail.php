...
<?php include "includes/navigation.php"?>
	...
	<main>
		<section id="hero_in" class="courses">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>xHirwa Online Shop</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
							...
							<div class="row add_top_20 add_bottom_30">
									...
									<ul class="list_teachers">
										<li>
											<a href="teacher-detail.html">
												<figure><img src="img/teacher_1_thumb.jpg" alt=""></figure>
												<h5>Tomas Hegel</h5>
												<p>Mathematics</p><i class="pe-7s-angle-right-circle"></i></a>
										</li>
										<li>
											<a href="teacher-detail.html">
												<figure><img src="img/teacher_2_thumb.jpg" alt=""></figure>
												<h5>Tomas Hegel</h5>
												<p>Mathematics</p><i class="pe-7s-angle-right-circle"></i></a>
										</li>
										<li>
											<a href="teacher-detail.html">
												<figure><img src="img/teacher_3_thumb.jpg" alt=""></figure>
												<h5>Tomas Hegel</h5>
												<p>Mathematics</p><i class="pe-7s-angle-right-circle"></i></a>
										</li>
									</ul>
								...
								<div class="col-lg-6">
									<ul class="list_teachers">
										<li>
											<a href="teacher-detail.html">
												<figure><img src="img/teacher_4_thumb.jpg" alt=""></figure>
												<h5>Tomas Hegel</h5>
												<p>Mathematics</p><i class="pe-7s-angle-right-circle"></i></a>
										</li>
										<li>
											<a href="teacher-detail.html">
												<figure><img src="img/teacher_5_thumb.jpg" alt=""></figure>
												<h5>Tomas Hegel</h5>
												<p>Mathematics</p><i class="pe-7s-angle-right-circle"></i></a>
										</li>
										<li>
											<a href="teacher-detail.html">
												<figure><img src="img/teacher_6_thumb.jpg" alt=""></figure>
												<h5>Tomas Hegel</h5>
												<p>Mathematics</p><i class="pe-7s-angle-right-circle"></i></a>
										</li>
									</ul>
